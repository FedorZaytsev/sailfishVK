...
public:
    explicit VKContainerDialog(QObject *parent = 0);
             ~VKContainerDialog();
    static VKContainerDialog* fromJson(VKStorage *storage, QJsonObject obj, const QJsonArray users = QJsonArray());
    ...
    void setUnreadCount(int arg)                { m_unreadCount = arg; }
    void setChatId(int arg)                     { m_chatId = arg; }
    void setIsChat(bool arg)                    { m_isChat = arg; }
    void setChatName(QString arg)               { m_chatName = arg; }
    void setChatIcon(VKContainerChatIcon* arg)  { m_chatIcon = arg; }
